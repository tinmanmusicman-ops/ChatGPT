...
# SUMMARY
Tier 2 and Tier 3 support specialist focused on taking ownership of complex customer interactions after Tier 1 automated workflows. Skilled at de-escalating frustration, correcting tone and direction in real time, and guiding conversations toward clear, confident resolution without unnecessary escalation. As engineered intelligence becomes more prevalent at the front line, prepared to engage customers who are either solution-focused or frustrated by automation, and to reestablish trust by providing empathy, clarity, and human judgment that ensures the customer feels heard, understood, and fully resolved.
...
### SIGNALS:
- Operated cash registers, processed cash/check/credit transactions, and balanced tills at shift end while following Walmart’s cash-handling policies.
- Assisted with merchandise processing and pricing updates to keep registers stocked and minimize customer wait time during peak hours.
- Completed Walmart’s cashier training, including register security, POS reconciliation, and routine drug/background check compliance.
