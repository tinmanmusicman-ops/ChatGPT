...
LAST_SUMMARY_TEXT_PATH = LOG_DIR / "last_content_summary.txt"
LAST_SUMMARY_HTML_PATH = LOG_DIR / "last_content_summary.html"
...
def _write_outputs(normalized_output: str, input_path: Path) -> Path:
    ...
    timestamped_text_path = LOG_DIR / f"content_summary_{stamp}.txt"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Summarize selected content text with OpenAI.")
    parser.add_argument("input_text_file", help="UTF-8 text file containing the selected content.")
