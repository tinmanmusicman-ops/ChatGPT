...
# SUMMARY
Versatile creative technologist with a lifelong foundation in music and a parallel career in software, automation, and AI-assisted workflows. Active since the early 1980s, with deep experience as a live musician, songwriter, recording engineer, and producer, combined with years of hands-on work designing calm, reliable systems that turn messy inputs into finished, usable outputs.

On the creative side, delivers recording, editing, mixing, cleanup, normalization, remixing, remastering, pitch and timing correction, and versioned audio deliverables. Comfortable originating material or refining client-provided recordings into polished, production-ready assets.

On the technical side, builds structured, repeatable workflows using software, automation, and AI as accelerators—not autonomous decision-makers. Experienced in process design, file handling, clou
...
Carlsbad, CA | September 2019 – September 2025

### SIGNALS:
- Maintained consistent 100% CSAT across financial and technical queues through empathetic
communication and strong issue ownership.
- Led performance metrics as the #1 advisor while remaining consistently in the top 10 monthly.
- Improved productivity and accuracy by partnering with leadership on process improvements.
- Completed a 10-month special project in 2 months by redesigning the workflow and automating in
Excel.
- Advanced quickly from training (Nov 2019) to Senior Advisor promotion (Feb 2020).  

### PROJECT: Auto Gen of html
...
### ROLE:
Forms Designeron/Implementation/Software Development
2004–2017
...
- Situation:
  - Company records were maintained using paper-based tracking, limiting visibility into accounting accuracy, job tracking, and outstanding receivables.
  - Lack of structured data and consistent workflow made reporting and ongoing maintenance difficult.

- What I did:
  - Migrated paper-based records into QuickBooks to improve accounting accuracy and job tracking.
  - Designed a consistent structure for customers, jobs, and categories to make data entry and reporting repeatable.
  - Standardized workflow so ongoing updates did not depend on a single individual.

- Tools / Systems:
  - QuickBooks accounting system
  - Structured data entry and categorization framework
  - Manual-to-digital record conversion workflow

- Result:
  - Improved accounting accuracy and visibility into active and completed jobs.
  - Established repeatable bookkeeping and reporting process.
  - Recovered $17,000 in previously un-invoiced receivables after migration.

- Evidense / Artifacts:
  - Operational QuickBooks records and structured customer/job database.
  - Verified recovery of outstanding receivables.

- Notes / Caveats:
  - Migration performed from fully manual paper system into structured accounting platform.
  - Process improvements focused on accuracy, repeatability, and financial visibility.

## COMPANY: Frazier Farms

### ROLE:
Part-time dishwasher and kitchen support associate.
...
- Situation:
  - Back-of-house dishwashing area was highly disorganized with no defined workflow, inconsistent methods, and large backlog of unprocessed dishes.
  - Lack of structure caused delays, inefficiency, and difficulty keeping up with kitchen demand in a high-volume environment.

- What I did:
  - Assessed workflow and identified bottlenecks causing backlog and inefficiency.
  - Designed and implemented a simple Standard Operating Procedure (SOP) to introduce structure and consistency.
  - Introduced categorization and staging method to sort dishware, utensils, and cookware by type.
  - Added pre-cleaning and preparation step to reduce wash time and improve throughput.
  - Established production-line workflow enabling continuous, systematic processing instead of reactive pile-based cleaning.

- Tools / Systems:
  - Commercial dishwashing station and sanitation workflow
  - Manual SOP design and workflow structuring
  - Staging, categorization, and process sequencing methods

- Result:
  - Reduced time required to clear dish backlog.
  - Improved overall kitchen support efficiency and workflow stability.
  - Enabled consistent, repeatable dishwashing process during high-volume operations.

- Evidense / Artifacts:
  - Observed reduction in backlog and improved processing speed.
  - Team adoption of structured workflow and staging method.

- Notes / Caveats:
  - Improvements implemented in a live operational environment with minimal tooling.
  - Demonstrated ability to rapidly analyze operational friction and implement practical process improvements in real-world conditions.
...
- What I did:
Became the de facto print operations lead due to prior print-industry experience.  Created step-by-step SOPs for maintaining printers, photo kiosks, and finishing equipment.  Designed preventative maintenance checklists to reduce downtime and service calls.  Built standardized production workflows for high-volume periods (Thanksgiving/Christmas cards, photo orders, specialty prints).  Established repeatable packaging, labeling, and order-handling procedures for team use.  Trained electronics staff on print workflows so any associate could execute consistently.  

- Tools/Systems:
Retail photo/print kiosks, commercial printers, finishing/binding equipment, maintenance checklists, SOP documentation.

Result:
Reduced equipment downtime through preventative maintenance routines.  Improved turnaround speed and order accuracy during peak holiday production.  Enabled cross-trained electronics staff to handle print operations without bottlenecks.  Created a repeatable, department-wide workflow that stabilized daily operations.  
